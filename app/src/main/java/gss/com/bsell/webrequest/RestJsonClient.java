        ...
        try {
            ...
            for(int index=0; index < nameValuePairs.size(); index++) {
                if(nameValuePairs.get(index).getName().equalsIgnoreCase("img1")
                        ...
                        ||nameValuePairs.get(index).getName().equalsIgnoreCase("img10")) {
                    try
                    {
//                       String type = null;
//                        String extension = MimeTypeMap.getFileExtensionFromUrl(nameValuePairs.get(index).getValue());
...
//java.io.FileNotFoundException: /storage/emulated/0/WhatsApp%20Business/Media/WhatsApp%20Business%20Images/IMG-20190509-WA0000.jpg (No such file or directory)