...
public class CategoryWiseProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferances = SharedPreferenceUtils.getInstance(CategoryWiseProducts.this);
        viewPager = (MyViewPager) CategoryWiseProducts.this.findViewById(R.id.viewpager);
        ...
        mLayoutManager = new LinearLayoutManager(CategoryWiseProducts.this);
        mRecyclerView.setLayoutManager(new GridLayoutManager(CategoryWiseProducts.this, 2));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mAdapter = new DiscoverItemsAdapter(CategoryWiseProducts.this, DiscoverItemsModelArrayList,category_id, IsDelete);
    ...
    public class DiscoverDataDemandAsynk extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            try {
                String url= CommonUtils.APP_URL+"product_by_maincategory";
