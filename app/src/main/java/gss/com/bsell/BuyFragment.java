...
//    private ViewPager viewPager;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_buy_fragment, container, false);
...
//        adapter.addFragment(new FavouritesFragment(), "FAVOURITES");
        ...
        adapter.addFragment(fragment, "Add Demand");
        adapter.addFragment(new DemandFragment(), "My Demand");
        adapter.addFragment(new PublicDemandFragment(), "Public Demand");
