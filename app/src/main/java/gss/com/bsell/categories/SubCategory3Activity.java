...
import gss.com.bsell.Adapter.SubCategory3Adapter;
...
public class SubCategory3Activity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    ArrayList<CategoriesModel> categoryList = new ArrayList<>();
    JSONObject json;
    private String catType="subthree";
    private String  sub_cat_2id="",sub_cat2="",cat_id="",category="",sub_catid="",sub_cat="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub_cat_2id=getIntent().getStringExtra("sub_cat2_id");
        ...
        mAdapter = new SubCategory3Adapter((Activity)this, categoryList, catType,
                sub_cat2,sub_cat_2id,sub_cat,sub_catid,category,cat_id,adType,amount,Mylist);
...
//            model.setImage(newJson.getString("image_url")+Category+"/"+i+".jpg");
            ...
            json = new SubCategory3Task().execute(Url,sub_cat_2id).get();
    ...
    public  class SubCategory3Task extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("category_id","79"));
