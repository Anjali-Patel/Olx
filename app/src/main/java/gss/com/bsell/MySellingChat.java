...
public class MySellingChat extends Fragment {
    ...
    public MySellingChat() {
        // Required empty public constructor
    }
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_my_selling_chat, container, false);
    ...
    public  class ShowUserChatHistoryAsynk extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("userdemad", params[2]));
